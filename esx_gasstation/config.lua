...
Config.format = {
	['currency'] = 'ARS',						-- This is the currency format, so that your currency symbol appears correctly [Examples: BRL, USD]
	['location'] = 'es-AR'						-- This is the location of your country, to format the decimal places according to your standard [Examples: pt-BR, en-US]
}
...
Config.clear_gas_stations = {
	...
	['min_stock_amount'] = 30,		-- Minimum percentage of inventory to consider an inactive store. Stores that have been inactive for a long time will be removed
